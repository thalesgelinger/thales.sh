...
>
  <div class="flex flex-col h-full px-6 py-12">
    ...
    <div class="flex-1 grid grid-cols-4 gap-4 content-start justify-items-center">
    ...
    <div class="flex justify-center gap-6 px-4 py-6 bg-card/50 backdrop-blur-xl rounded-3xl border border-border/50 mx-2">
      <a
